...
namespace LiveAI.FastBlazor.Base
{
    ...
    {       
        ...
        /// <summary>
        /// Mapper to compute a component class based on <see cref="ClassMapper.AddIf(string, Func{bool})"/> methods.
        /// </summary>
        protected virtual ClassMapper ClassMapper { get; } = new ClassMapper();
